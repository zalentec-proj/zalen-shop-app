...
const server = http.createServer((request, response) => {
  ...
  response.end('<h1>Autorizado</h1><p>A auditoria de dimensões foi iniciada. Pode voltar ao Codex.</p>');
  const child = spawn(process.execPath, ['scripts/bling/audit-brasil-drones-dimensions.mjs'], {
    cwd: ROOT,
...
server.listen(PORT, '127.0.0.1', () => {
  ...
  console.log('Modo: AUDITORIA SEM ALTERAÇÕES.');
