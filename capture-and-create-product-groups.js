...
const server = http.createServer((request, response) => {
  ...
  console.log('Code recebido. Criando grupos e vinculando produtos...');
  runCreateGroups(code);
});
...
function runCreateGroups(code) {
  const child = spawn(process.execPath, ['create-product-groups.js'], {
    cwd: ROOT,
    env: {
      ...process.env,
