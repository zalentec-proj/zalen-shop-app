...
export const droneModelDefinitions: DroneModelDefinition[] = [
  ...
  { lineSlug: 'mini', name: 'Mini SE', slug: 'mini-se', aliases: ['mini se', 'dji mini se'], position: 40 },
  { lineSlug: 'mini', name: 'Mini 4K', slug: 'mini-4k', aliases: ['mini 4k', 'dji mini 4k'], position: 50 },
  { lineSlug: 'mini', name: 'Mini 3', slug: 'mini-3', aliases: ['mini 3', 'dji mini 3'], position: 60 },
  { lineSlug: 'mini', name: 'Mini 3 Pro', slug: 'mini-3-pro', aliases: ['mini 3 pro', 'dji mini 3 pro'], position: 70 },
  { lineSlug: 'mini', name: 'Mini 4 Pro', slug: 'mini-4-pro', aliases: ['mini 4 pro', 'dji mini 4 pro'], position: 80 },
  { lineSlug: 'mini', name: 'Mini 5 Pro', slug: 'mini-5-pro', aliases: ['mini 5 pro', 'dji mini 5 pro'], position: 90 },
  ...
  { lineSlug: 'mavic', name: 'Mavic Platinum', slug: 'mavic-platinum', aliases: ['mavic platinum', 'dji mavic platinum'], position: 20 },
  { lineSlug: 'mavic', name: 'Mavic 2', slug: 'mavic-2', aliases: ['mavic 2', 'dji mavic 2'], position: 30 },
  { lineSlug: 'mavic', name: 'Mavic 2 Pro', slug: 'mavic-2-pro', aliases: ['mavic 2 pro', 'dji mavic 2 pro'], position: 40 },
  { lineSlug: 'mavic', name: 'Mavic 2 Zoom', slug: 'mavic-2-zoom', aliases: ['mavic 2 zoom', 'dji mavic 2 zoom'], position: 50 },
  { lineSlug: 'mavic', name: 'Mavic 3', slug: 'mavic-3', aliases: ['mavic 3', 'dji mavic 3'], position: 60 },
  { lineSlug: 'mavic', name: 'Mavic 3 Classic', slug: 'mavic-3-classic', aliases: ['mavic 3 classic', 'dji mavic 3 classic'], position: 70 },
  { lineSlug: 'mavic', name: 'Mavic 3 Pro', slug: 'mavic-3-pro', aliases: ['mavic 3 pro', 'dji mavic 3 pro'], position: 80 },
  { lineSlug: 'mavic', name: 'Mavic 3 Cine', slug: 'mavic-3-cine', aliases: ['mavic 3 cine', 'dji mavic 3 cine'], position: 90 },
  { lineSlug: 'mavic', name: 'Mavic 4 Pro', slug: 'mavic-4-pro', aliases: ['mavic 4 pro', 'dji mavic 4 pro'], position: 100 },
