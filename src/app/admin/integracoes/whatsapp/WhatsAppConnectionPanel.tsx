...
const connectionStatusLabels: Record<WhatsAppAdminState['connectionStatus'], string> = {
...
export function WhatsAppConnectionPanel({ initialState }: { initialState: WhatsAppAdminState }) {
  ...
  const run = (operation: () => Promise<{ qrCodeDataUrl?: string; state?: WhatsAppAdminState; [key: string]: unknown } | void>, success: string) => {
    setNotice(undefined);
