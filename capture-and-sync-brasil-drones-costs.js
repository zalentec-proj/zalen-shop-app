...
const server = http.createServer((request, response) => {
  ...
  response.end(
    auditOnly
      ? '<h1>Autorizado</h1><p>A auditoria de fornecedores foi iniciada. Pode voltar ao Codex.</p>'
      : '<h1>Autorizado</h1><p>A atualização dos preços de custo foi iniciada. Pode voltar ao Codex.</p>'
  );

  const child = spawn(process.execPath, ['scripts/bling/sync-brasil-drones-supplier-costs.mjs'], {
    cwd: ROOT,
